...
const PrivacyPolicy = () => (
    <div>
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to Social Manager Pro, accessible from <a href="https://localhost:3000" rel="external nofollow noopener" target="_blank">http://localhost:3000</a></p>
            </li>
            <li>
