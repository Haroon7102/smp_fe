...
const FacebookVideoPost = () => {
    ...
    const handlePost = async () => {
        if (!selectedPageId || !videoFile) {
            alert('Please select a page and upload a video.');
            return;
        }
        ...
        if (selectedPage) {
            ...
            try {
                ...
                if (result.success) {
                    // Update the recentPosts dynamically
                    ...
                    alert('Error posting the video. Please try again.');
                }
            } catch (error) {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px', maxWidth: '600px', margin: 'auto' }}>
            <h1 style={{ textAlign: 'center', color: '#4267B2' }}>Facebook Video Poster</h1>
...
export default FacebookVideoPost;
